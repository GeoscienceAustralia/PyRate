...
def mst_from_ifgs(ifgs):
    ...
    edges_with_weights_for_networkx = [(i.main, i.subordinate, i.nan_fraction)
                                       for i in ifgs]
...
def mst_multiprocessing(tile, ifgs_or_paths, preread_ifgs=None, params=None):
    ...
    #interferogram header information (like mains/subordinate dates) for MST
...
def mst_matrix_networkx(ifgs):
    ...
    edges_with_weights = [(i.main, i.subordinate, i.nan_fraction) for i in ifgs]
