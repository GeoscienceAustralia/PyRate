...
class PrepifgConversionTests(unittest.TestCase):
    ...
    def test_tifs_succeeds(self):
        converttogeotif.main(self.params)
        prepifg.main(self.params)
