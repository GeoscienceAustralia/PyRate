...
names = ['Velocity', 'Error', 'R_square']
units = ['mm/yr', 'mm/yr', '']

velfile = os.path.join(path, 'linear_rate.tif')
Errofile = os.path.join(path, 'linear_error.tif')
Rsqrfile = os.path.join(path, 'linear_rsquared.tif') # temporarily
files = [velfile, Errofile, Rsqrfile ]
