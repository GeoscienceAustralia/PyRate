...
if __name__ == "__main__":
    parser = OptionParser(usage="%prog -i input_file -o output_file" " -e extents\n" "Crop a larger interferogram into " "smaller ones")
    parser.add_option("-i", "--input", type=str, dest="input_file", help="name of input interferogram")

    parser.add_option("-o", "--out", type=str, dest="output_file", help="name of cropped output interferogram")
    ...
    if len(extents) != 4:
        raise AttributeError(
            "extents to be used for the cropped file.\n"
    ...
    crop_using_gdalwarp(input_file=options.input_file, output_file=options.output_file, extents=extents)
