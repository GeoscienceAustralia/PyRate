...
::
    ...
    pyrate linrate pyrate_gamma.conf
    pyrate postprocess pyrate_gamma.conf
...
::
    ...
    mpirun -n 4 pyrate linrate pyrate_gamma.conf -c 2 -r 2
    mpirun -n 4 pyrate postprocess pyrate_gamma.conf -c 2 -r 2
